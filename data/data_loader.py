...
# 示例用法
high_dim_path = 'path/to/high_dim_features.csv'
low_dim_path = 'path/to/low_dim_features.csv'
labels_path = 'path/to/labels.csv'

train_dataset, test_dataset = load_and_align_data(high_dim_path, low_dim_path, labels_path)
